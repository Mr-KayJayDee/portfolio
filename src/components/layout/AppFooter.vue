    ...
    <div class="container">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-xl mb-2xl">
        ...
        <div class="md:col-span-2">
          ...
          <!-- Social Links -->
          <div class="flex gap-md" role="list" aria-label="Social media links">
            <a v-for="social in siteConfig.social" :key="social.name" :href="social.url" target="_blank"
              rel="noopener noreferrer" class="social-link" :title="`Follow on ${social.name}`"
        ...
        <nav aria-label="Footer navigation">
          ...
          <ul class="space-y-sm" role="list">
            <li v-for="link in quickLinks" :key="link.name" role="listitem">
        ...
        <div>
          ...
          <ul class="space-y-sm" role="list">
            <li v-for="service in services" :key="service" role="listitem">
      ...
      <div class="footer-bottom">
        <div class="flex flex-col md:flex-row justify-between items-center gap-md">
          ...
          <nav class="flex gap-lg text-sm" aria-label="Legal links">
            <a href="/legal" class="footer-link">{{ t('footer.legalNotices') }}</a>
            <a href="/privacy" class="footer-link">{{ t('footer.privacyPolicy') }}</a>
          </nav>
        </div>
      </div>
    </div>
